...
$(document).scroll(function() {
  ...
  if (main.opt.togBut.hasClass("tog_mnu") && main.opt.togBut.click(), !$("#portfolio, .last-portfolio ").hasClass("no-animation"))
    for (var e = 0; e < startAnimPort.length; e++) t + 30 > startAnimPort[e] ? $(".wrap_prew").eq(e).addClass("animated fadeInLeft") : $(".wrap_prew").eq(e).removeClass("animated fadeInLeft");
  for (var e = 0; e < position.length; e++) main.scrollBlock(t, e), t > main.opt.position[e] ? main.opt.elements.eq(e).addClass("activeSection") : main.opt.elements.eq(e).removeClass("activeSection");
  var n = $("header").height();
